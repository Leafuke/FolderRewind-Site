      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'guides/minebackup-v1/first-restore',
            'guides/minebackup-v1/backup-modes',
            'guides/minebackup-v1/history-and-restore',
            'guides/minebackup-v1/automation',
            'guides/minebackup-v1/special-mode',
            'guides/minebackup-v1/hot-backup',
