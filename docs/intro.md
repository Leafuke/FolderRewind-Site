...
- 支持 **定时/间隔/启动时** 三种自动化备份模式
- 通过 **历史时间轴** 回溯到任意备份时间点
- 通过 **插件系统** 为特定场景（如 Minecraft）深度优化
...
> **Minecraft 玩家？** 安装 [MineRewind 插件](./guides/minecraft)后，可自动扫描并发现所有存档文件夹。
...
- [Minecraft 专题](./guides/minecraft) — MC 玩家必读
